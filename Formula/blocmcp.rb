class Blocmcp < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      def install
          bin.install "blocmcp_v0.0.1_darwin_arm64" => "blocmcp"
      end
    else
      ...
      def install
          bin.install "blocmcp_v0.0.1_darwin_amd64" => "blocmcp"
      end
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      def install
          bin.install "blocmcp_v0.0.1_linux_arm64" => "blocmcp"
      end
    else
      ...
      def install
          bin.install "blocmcp_v0.0.1_linux_amd64" => "blocmcp"
      end
    end
  end
